...
export default function Line(props) {
  ...
  const style = {
    ...
    strokeDasharray: (layer['paint'] !== undefined && layer['paint']['line-dasharray'] !== undefined) ? layer['paint']['line-dasharray'] : "",
    strokeLinecap: (layer['paint'] !== undefined && layer['paint']['line-linecap'] !== undefined) ? layer['paint']['line-linecap'] : "",
